class GitWrapper():
    ...
    def init(repo_config):
        ...
        if 'skip-submodules' not in repo_config or not repo_config['skip-submodules']:
    ...
    def clone(repo_config):
        ...
        submodules_attr = '' if 'skip-submodules' in repo_config and repo_config['skip-submodules'] else '--recursive '
        commands.append('git clone ' + submodules_attr + ' ' + repo_config['url'] + ' -b ' + repo_config['branch'] + ' ' + repo_config['path'])
